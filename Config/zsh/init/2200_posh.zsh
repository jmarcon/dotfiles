...
# if ! eval "$(oh-my-posh init zsh --config /Users/jm/.git_repos/dotfiles/Config/posh/radar.omp.toml)"; then
# 	echo '  ❌ Failed to initialize Oh-My-Posh with radar theme'
# 	print_error '  ❌ Failed to initialize Oh-My-Posh'
# else
# 	return 0
# fi
